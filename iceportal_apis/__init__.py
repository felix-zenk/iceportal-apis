...
def get_connections_info(connections):
    """Processes information on a given dict of connections
    Returns some useful details:
        {trainName, finalStation, departure, track}
    example:
        [{'trainName': 'S 5', 'finalStation': 'Hameln', 'departureTime': datetime.datetime(2020, 12, 26, 15, 25), 'track': '1'}, ...]
    """
    connections_info = []
